...
async function main() {
    ...
    let relay_addr = "0x9d4620AFd8e0e82613b921909aDb3FD86e6641e2";
    let usdc_token_addr = "0xc5182b6a51f32c654D082fEF90e6FD737fE1Cc24";
    ...
    await upgrades.upgradeProxy(
        ...
        Relay,
        {
            kind: "uups",
            constructorArgs: [
                '0xab16e8e8CBDdDd46CEFD587F8DcAC86F9D1f321D',
                600,
                "0xc5182b6a51f32c654D082fEF90e6FD737fE1Cc24",
                1000,
                50000,
                600,
                2,
    ...
    let codeHash = keccak256(solidityPacked(["string"], ["codehash"])),
        ...
        userTimeout = 1001,
        maxGasPrice = 100,
        callbackDeposit = parseUnits("10000000", "gwei"),
